    ...
    <div className="group bg-slate-900/50 backdrop-blur-sm border border-orange-500/20 hover:border-orange-500/50 hover:bg-slate-900/70 rounded-xl p-4 md:p-5 transition-all">
      <div className="flex flex-col gap-3 md:gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex items-start gap-3 md:gap-5">
          <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 shrink-0 bg-slate-800/50 rounded-lg flex items-center justify-center overflow-hidden border border-orange-500/10">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-wrap items-center gap-2 md:gap-3 mb-2">
              ...
              <CertificateStatusBadge
                hasTemplate={Boolean(certificate.imageUrl)}
              />
            </div>
            <div className="flex flex-wrap items-center gap-2 md:gap-4 text-xs md:text-sm text-orange-200/50">
        ...
        <div className="flex items-center justify-end gap-2 w-full lg:w-auto flex-nowrap shrink-0">
          <Button
            variant="ghost"
            size="sm"
